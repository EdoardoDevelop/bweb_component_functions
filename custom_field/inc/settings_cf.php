...
class BcCustomFieldOptions {
    ...
    public function load_enqueue(){
		...
		add_thickbox();
		wp_enqueue_script( 'settings_cf-vanillaSelectBox_js', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ).'custom_field/assets/vanillaSelectBox.js' );

		wp_enqueue_style( 'settings_cf-vanillaSelectBox_css', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ).'custom_field/assets/vanillaSelectBox.css');
		wp_enqueue_style( 'settings_cf-css', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ).'custom_field/assets/style.css');
    }
