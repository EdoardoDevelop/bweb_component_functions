 ...
 */
 ...
 class BCInstallPlugin {
	...
	public function plugin_callback() {
        ...
        $list = json_decode( wp_remote_retrieve_body( wp_remote_get( "https://raw.githubusercontent.com/EdoardoDevelop/bweb_component_functions/tree/master/tgm-plugin-activation/plugin-wp.json" ) ), true );
        $plugin_active = array();
